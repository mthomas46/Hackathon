...
class EcosystemAuditor:
    ...
    def __init__(self):
        self.services = {
            ...
            "mock-data-generator": ServiceConfig(
                "mock-data-generator", 5065, "/health", "hackathon-mock-data-generator-1"
            ),
            ...
            "architecture-digitizer": ServiceConfig(
                "architecture-digitizer", 5105, "/health", "hackathon-architecture-digitizer-1"
            ),
            "notification-service": ServiceConfig(
                "notification-service", 5130, "/health", "hackathon-notification-service-1"
            ),
    ...
    async def test_service_connectivity(self, service_name: str, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            with urllib.request.urlopen(url, timeout=5) as response:
                ...
                try:
                    ...
                    if config.expected_response_keys:
                        missing_keys = [key for key in config.expected_response_keys if key not in json_data]
                        if missing_keys:
            ...
            return {"service": service_name, "status": "connection_failed", "error": str(e), "url": url}
        except Exception as e:
            return {"service": service_name, "status": "error", "error": str(e), "url": url}
    ...
    async def test_docker_health_status(self, service_name: str, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return {"service": service_name, "docker_health": docker_status, "container_name": config.docker_name}
            else:
                return {"service": service_name, "docker_health": "unknown", "error": result.stderr.strip()}

        except Exception as e:
            return {"service": service_name, "docker_health": "error", "error": str(e)}
    ...
    async def test_basic_functionality(self, service_name: str, config: ServiceConfig) -> Dict[str, Any]:
        ...
        if service_name in functional_tests:
            try:
                ...
                return {"service": service_name, "functional_test": "error", "error": str(e)}
        else:
            return {"service": service_name, "functional_test": "not_implemented"}
    ...
    async def test_service_integration(self, service_name: str, config: ServiceConfig) -> Dict[str, Any]:
        ...
        if service_name in integration_tests:
            try:
                ...
                return {"service": service_name, "integration_test": "error", "error": str(e)}
        else:
            return {"service": service_name, "integration_test": "not_implemented"}
    ...
    async def test_load_performance(self, service_name: str, config: ServiceConfig) -> Dict[str, Any]:
        ...
        if service_name in load_tests:
            try:
                ...
                return {"service": service_name, "load_test": "error", "error": str(e)}
        else:
            return {"service": service_name, "load_test": "not_implemented"}
    ...
    async def _test_doc_store_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "doc_store", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_orchestrator_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "orchestrator", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_llm_gateway_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "llm-gateway", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_discovery_agent_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "discovery-agent", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_analysis_service_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "analysis-service", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_frontend_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "frontend", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_notification_service_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "notification-service", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_code_analyzer_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "code-analyzer", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_source_agent_functionality(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"service": "source-agent", "functional_test": "failed", "error": str(e)}
    ...
    async def _test_source_agent_integration(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        integration_results = {"service": "source-agent", "integration_test": "success", "doc_store_integration": False}
    ...
    async def _test_doc_store_load(self, config: ServiceConfig) -> Dict[str, Any]:
        ...
        if response_times:
            ...
            load_results["error_rate"] = (
                load_results["requests_made"] - load_results["successful_requests"]
            ) / load_results["requests_made"]
    ...
    async def _create_test_document(self, doc_data: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            req = urllib.request.Request(
                "http://localhost:5087/api/v1/documents", data=json_data, headers={"Content-Type": "application/json"}
            )

            with urllib.request.urlopen(req, timeout=10) as response:
                if response.getcode() == 201:
                    result = json.loads(response.read().decode("utf-8"))
                    return {"success": True, "document_id": result.get("document_id"), "response": result}
                else:
    ...
    async def _analyze_test_document(self, doc_id: str) -> Dict[str, Any]:
        ...
        try:
            analysis_data = {"document_id": doc_id, "analysis_types": ["basic_analysis"]}
            ...
            with urllib.request.urlopen(req, timeout=15) as response:
                if response.getcode() == 200:
                    result = json.loads(response.read().decode("utf-8"))
                    return {"success": True, "analysis_id": result.get("analysis_id"), "response": result}
                else:
                    return {"success": False, "error": f"HTTP {response.getcode()}"}
    ...
    async def _summarize_test_document(self, doc_id: str) -> Dict[str, Any]:
        ...
        try:
            summary_data = {"document_id": doc_id, "summary_type": "basic"}

            json_data = json.dumps(summary_data).encode("utf-8")
            req = urllib.request.Request(
                "http://localhost:5160/api/v1/summarize", data=json_data, headers={"Content-Type": "application/json"}
            )

            with urllib.request.urlopen(req, timeout=15) as response:
                if response.getcode() == 200:
                    result = json.loads(response.read().decode("utf-8"))
                    return {"success": True, "summary": result.get("summary"), "response": result}
                else:
                    return {"success": False, "error": f"HTTP {response.getcode()}"}
    ...
    def _identify_critical_issues(self, results: Dict[str, Any]) -> List[str]:
        ...
        connectivity = results["connectivity_tests"]
        failed_services = [s for s, r in connectivity.items() if r["status"] in ["connection_failed", "error"]]
