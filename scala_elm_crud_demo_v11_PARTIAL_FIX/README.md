...
```
scala_elm_crud_demo_v11_PARTIAL_FIX/
├── README.md                             (This file)
├── data/
...
- Jira tickets: 3 tickets (30%)
- Confluence docs: 3 documents (30%)
- GitHub PRs: 4 pull requests (40%)
- **Total:** 10 documents
...
| **Total Historical Documents** | 10 (30% Jira, 30% Confluence, 40% GitHub) |
| **Tangential Service Docs** | 2 |
| **Team Members** | 5 |
| **Tech Stack** | Python, iOS, Android, React, Firebase |
| **Output Folder** | `scala_elm_crud_demo_v11_PARTIAL_FIX/` |
