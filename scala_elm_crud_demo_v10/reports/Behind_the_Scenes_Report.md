...
**Generated:** 2025-10-03 23:37:26 UTC  
...
| **Demo Folder** | `scala_elm_crud_demo_v10/` |
...
**Total Documents for Analysis: 39**
...
**CONF-002: iOS Architecture Overview**
...
**CONF-003: Team Guide: Working with Android**
...
```
scala_elm_crud_demo_v10/data/mock_data.json
```
...
| **E** | External Service Validation | 88% final confidence | 0.01s |
...
- **Total Documents Analyzed:** 39 documents (34 historical + 5 tangential)
