...
- **8 Services** discovered from 12 historical documents
- **22 Document-Service Linkings** created
...
**Current Data:**
- **Jira Tickets:** 3 documents
- **Confluence Docs:** 3 documents
- **GitHub PRs:** 4 documents
- **Total:** 10 documents
...
- **Confluence → Services:** 10 linkings
- **GitHub → Services:** 2 linkings
- **Total Links:** 22 linkings
...
- **8 services** discovered from 12 documents
- **22 total mentions** across all documents
- **8 unique services** cataloged
- **22 document-service linkings** established
