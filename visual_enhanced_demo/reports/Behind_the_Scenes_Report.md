...
| Parameter | Value |
|-----------|-------|
| **Feature Request** | Build secure API gateway with rate limiting, OAuth 2.0, JWT validation, and request routing... |
| **Total Historical Documents** | 15 documents (split: 30% Jira, 30% Confluence, 40% GitHub) |
| **Team Members Generated** | 6 |
| **Tech Stack** | Python, FastAPI, OAuth, JWT, Redis, PostgreSQL, Docker, Kubernetes |
| **Tangential Service Docs** | 10 |
| **Demo Folder** | `visual_enhanced_demo/` |
...
**Historical Documents: 14 documents**
- 4 Jira tickets (30% of total parameter)
- 4 Confluence documents (30% of total parameter)
- 6 GitHub PRs (40% of total parameter)

**Tangential Service Documents: 10 documents**
- External service documentation for integration context
- Used to enhance service discovery and validation

**Total Documents for Analysis: 24**

#### Jira Tickets (4 tickets)
...
The average estimate accuracy of 96.2%
indicates team estimation reliability.

#### Confluence Documents (4 docs)
...
**CONF-003: Team Guide: Working with OAuth**
...
**PR-0458: refactor: Improve OAuth implementation**
...
```
visual_enhanced_demo/data/mock_data.json
```
...
**Process:**
1. Searched 15 historical tickets
...
|-------|-----------|-------------|--------|
| **doc-store** | Historical Documents | 14 | ✅ |
| **prompt-store** | Workflow Prompts | 8 | ✅ |
| **external-service-store** | Discovered Services | 16 services | ✅ |
...
**Data Breakdown:**
- **Total Historical Documents:** 15 (parameter)
  - **Jira Tickets:** 4 tickets (30% of total)
  - **Confluence Docs:** 4 documents (30% of total)
  - **GitHub PRs:** 6 pull requests (40% of total)
- **Tangential Service Docs:** 10 external service documents
- **Total Documents Analyzed:** 24 documents (14 historical + 10 tangential)
- **Services Discovered:** 16 services from document analysis
- **Workflow Prompts:** 8 specialized prompts for planning
- **Workflow Contexts:** 5 workflow executions (A, B, C, D, E)

**Persistence Results:**
- ✅ **doc-store:** 14/14 documents saved
- ✅ **prompt-store:** 8/8 prompts saved
- ✅ **external-service-store:** 16/16 services saved
...
- 4 Jira tickets analyzed
- 4 Confluence documents reviewed
- 6 GitHub PRs analyzed
- Average Estimate Accuracy: 96.2%
...
| Metric | Value |
|--------|-------|
| **Unique Users Extracted** | 10 users |
| **Documents Processed** | 14 documents |
| **SMEs Identified** | 12 experts |
| **Collaboration Relationships** | 10 relationships |
...
|--------------|-----------|----------------------|-----------------|
| **GitHub PRs** | 6 | ~10 | Author, Reviewers, Assignees, Merger, Commit Authors, Commenters |
| **Jira Tickets** | 4 | ~8 | Reporter, Assignee, Watchers, Worklog Contributors, Commenters |
| **Confluence Docs** | 4 | ~8 | Author, Editors, Maintainers, Watchers, Commenters |

**Total Unique Users After Deduplication**: 10
...
5. **Sarah Chen**: 5 interactions, topics: Python, FastAPI, OAuth
...
- **Sarah Chen**: Confidence 0.18, 0 contributions

- **Sarah Chen**: Confidence 0.18, 0 contributions

- **Sarah Chen**: Confidence 0.18, 0 contributions

  *...and 9 more Unknown experts*
...
- ✅ Extracted 10 unique users from 14 documents
- ✅ Identified 12 subject matter experts
- ✅ Built collaboration graph with 10 relationships
