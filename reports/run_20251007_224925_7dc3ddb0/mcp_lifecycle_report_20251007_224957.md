...
**Generated**: 2025-10-07 22:49:57  
**Correlation ID**: bfd611ca-1722-47d9-bcd1-acd9dc1bc230  
**MCP ID**: mcp_b9c833ea  
...
**Overall Success Rate**: 48.4% (15/31 checks passed)
...
- **Training Job ID**: job-4a6101f8068c
- **Status**: ✅ PASS
...
5. MCP Creation                ✅ MCP ID: mcp_b9c833ea
...
**Response Preview**:
```
{'success': False, 'status_code': 503, 'body': None, 'headers': {}, 'instance_id': '', 'instance_url': '', 'response_time_ms': 0.0, 'strategy_used': '', 'error_message': 'No available instances for mcp_b9c833ea', 'error_type': 'NO_INSTANCES_AVAILABLE'}
```
...
### Reports Directory (`reports/run_20251007_224925_7dc3ddb0`)
