...
**Overall Success Rate**: 45.7% (16/35 checks passed)
...
- **Training Job ID**: job-0414c9edf090
- **Status**: ✅ PASS
...
5. MCP Creation                ✅ MCP ID: mcp_1fd29a5b
...
### Training Data
- **Documents Used**: 50
- **Total Content Size**: 713,998 characters
- **Sample Documents**:
...
**Response Preview**:
```
{'success': False, 'status_code': 503, 'body': None, 'headers': {}, 'instance_id': '', 'instance_url': '', 'response_time_ms': 0.0, 'strategy_used': '', 'error_message': 'No available instances for mcp_1fd29a5b', 'error_type': 'NO_INSTANCES_AVAILABLE'}
```
...
- **doc_store** (http://localhost:5087): ✅ PASS
...
### Reports Directory (`reports/run_20251008_161150_2fd7705d`)
