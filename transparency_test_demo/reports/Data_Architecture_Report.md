...
- **6 Services** discovered from 5 historical documents
- **14 Document-Service Linkings** created
...
**Current Data:**
- **Services Discovered:** 6 services
- **Services Stored:** 6 services
- **Document Links:** 14 linkings
...
| **external-service-store** | Discovered Services | 6 | ✅ |
...
- **Services Stored:** 6
- **Document-Service Links:** 14
- **Discovery Confidence:** 0.88
...
After Demo Run:
  ...
  external-service-store: 6 services (+6)
...
- **6 services** discovered from 5 documents
- **14 total mentions** across all documents
- **6 unique services** cataloged
- **14 document-service linkings** established
