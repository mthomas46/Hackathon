...
- **18 Services** discovered from 30 historical documents
- **76 Document-Service Linkings** created
...
**Current Data:**
- **Services Discovered:** 18 services
- **Services Stored:** 18 services
- **Document Links:** 76 linkings
...
- **Confluence → Services:** 21 linkings
- **GitHub → Services:** 5 linkings
- **Total Links:** 76 linkings
...
| **external-service-store** | Discovered Services | 18 | ✅ |
...
After Demo Run:
  ...
  external-service-store: 18 services (+18)
...
- **18 services** discovered from 30 documents
- **76 total mentions** across all documents
- **18 unique services** cataloged
- **76 document-service linkings** established
