...
class BulkOperationHandlers:
    ...
    async def handle_create_bulk_operation(
        self, operation_data: BulkOperationCreate
    ) -> Dict[str, Any]:
        """Create a new bulk operation."""
        try:
            operation = self.service.create_entity(operation_data.dict())
            return create_success_response(
                message="Bulk operation created successfully", data=operation.to_dict()
            )
        except ValueError as e:
            return create_error_response(str(e), "VALIDATION_ERROR")
        except Exception as e:
            return create_error_response(
                f"Failed to create bulk operation: {str(e)}", "INTERNAL_ERROR"
            )
    ...
    async def handle_bulk_create_prompts(
        ...
        try:
            ...
            return create_success_response(
                message="Bulk create operation initiated", data=operation.to_dict()
            )
        except ValueError as e:
            return create_error_response(str(e), "VALIDATION_ERROR")
        except Exception as e:
    ...
    async def handle_bulk_update_prompts(
        ...
        try:
            ...
            return create_success_response(
                message="Bulk update operation initiated", data=operation.to_dict()
            )
        except ValueError as e:
            return create_error_response(str(e), "VALIDATION_ERROR")
        except Exception as e:
    ...
    async def handle_bulk_delete_prompts(
        self, prompt_ids: List[str], created_by: str = "api_user"
    ) -> Dict[str, Any]:
        """Create bulk delete prompts operation."""
        try:
            operation = self.service.create_bulk_delete_operation(
                prompt_ids, created_by
            )
            return create_success_response(
                message="Bulk delete operation initiated", data=operation.to_dict()
            )
        except ValueError as e:
            return create_error_response(str(e), "VALIDATION_ERROR")
        except Exception as e:
    ...
    async def handle_bulk_update_tags(
        ...
        try:
            ...
            return create_success_response(
                message="Bulk tag update operation initiated", data=operation.to_dict()
            )
        except ValueError as e:
            return create_error_response(str(e), "VALIDATION_ERROR")
        except Exception as e:
    ...
    async def handle_get_bulk_operation(self, operation_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_error_response(
                f"Failed to get bulk operation: {str(e)}", "INTERNAL_ERROR"
            )
    ...
    async def handle_get_operation_status(self, operation_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_success_response(
                message="Operation status retrieved successfully", data=status
            )
        except ValueError as e:
            return create_error_response(str(e), "VALIDATION_ERROR")
        except Exception as e:
            return create_error_response(
                f"Failed to get operation status: {str(e)}", "INTERNAL_ERROR"
            )
    ...
    async def handle_list_bulk_operations(
        ...
        try:
            ...
            return create_success_response(
                message="Bulk operations retrieved successfully", data=result
            )
        except Exception as e:
            return create_error_response(
                f"Failed to list bulk operations: {str(e)}", "INTERNAL_ERROR"
            )
    ...
    async def handle_cancel_operation(self, operation_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_error_response(
                f"Failed to cancel operation: {str(e)}", "INTERNAL_ERROR"
            )
    ...
    async def handle_retry_operation(self, operation_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_success_response(
                message="Bulk operation retry initiated", data=operation.to_dict()
            )
        except ValueError as e:
            return create_error_response(str(e), "VALIDATION_ERROR")
        except Exception as e:
            return create_error_response(
                f"Failed to retry operation: {str(e)}", "INTERNAL_ERROR"
            )
    ...
    async def handle_cleanup_operations(self, days_old: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_error_response(
                f"Failed to cleanup operations: {str(e)}", "INTERNAL_ERROR"
            )
