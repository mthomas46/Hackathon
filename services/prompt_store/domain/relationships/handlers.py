...
class RelationshipsHandlers:
    ...
    async def handle_create_relationship(
        self, source_prompt_id: str, relationship_data: PromptRelationshipCreate, user_id: str = "api_user"
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.relationships_service.create_relationship(source_prompt_id, rel_dict, user_id)

            response = create_success_response(
                data=result, message=f"Relationship '{relationship_data.relationship_type}' created between prompts"
            )
    ...
    def handle_get_relationships(self, prompt_id: str, direction: str = "both") -> Dict[str, Any]:
        ...
        try:
            ...
            response = create_success_response(data=result, message=f"Retrieved relationships for prompt {prompt_id}")
            return response.model_dump()
    ...
    def handle_update_relationship_strength(
        self, relationship_id: str, new_strength: float, user_id: str = "api_user"
    ) -> Dict[str, Any]:
        """Handle request to update relationship strength."""

        try:
            result = self.relationships_service.update_relationship_strength(relationship_id, new_strength, user_id)

            response = create_success_response(data=result, message=f"Relationship strength updated to {new_strength}")
            return response.model_dump()
    ...
    def handle_delete_relationship(self, relationship_id: str, user_id: str = "api_user") -> Dict[str, Any]:
        ...
        try:
            ...
            response = create_success_response(data=result, message="Relationship deleted successfully")
            return response.model_dump()
    ...
    def handle_get_relationship_graph(self, prompt_id: str, depth: int = 2) -> Dict[str, Any]:
        ...
        try:
            ...
            response = create_success_response(
                data=result, message=f"Retrieved relationship graph for prompt {prompt_id}"
            )
            return response.model_dump()
    ...
    def handle_get_relationship_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = create_success_response(data=result, message="Retrieved relationship statistics")
            return response.model_dump()

        except Exception as e:
            raise HTTPException(status_code=500, detail=f"Failed to retrieve statistics: {str(e)}")

    def handle_find_related_prompts(
        ...
        try:
            result = self.relationships_service.find_related_prompts(prompt_id, relationship_types, min_strength)

            response = create_success_response(data=result, message=f"Found {result['total_related']} related prompts")
            return response.model_dump()
    ...
    def handle_validate_relationship(
        self, source_prompt_id: str, target_prompt_id: str, relationship_type: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            response = create_success_response(data=result, message="Relationship validation completed")
            return response.model_dump()
