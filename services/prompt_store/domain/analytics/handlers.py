    ...
    async def handle_record_usage_metrics(
        ...
        try:
            ...
            return create_error_response(
                f"Failed to record usage metrics: {str(e)}", "INTERNAL_ERROR"
            ).model_dump()

    async def handle_record_satisfaction(
        ...
        try:
            ...
            return create_error_response(
                f"Failed to record satisfaction: {str(e)}", "INTERNAL_ERROR"
            ).model_dump()

    async def handle_get_analytics_dashboard(
        ...
        try:
            ...
            return create_error_response(
                f"Failed to get analytics dashboard: {str(e)}", "INTERNAL_ERROR"
            ).model_dump()

    async def handle_get_prompt_metrics(
        ...
        try:
            ...
            return create_error_response(
                f"Failed to get prompt metrics: {str(e)}", "INTERNAL_ERROR"
            ).model_dump()

    async def handle_get_performance_overview(
        self, time_range_days: int = 30
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_error_response(
                f"Failed to get performance overview: {str(e)}", "INTERNAL_ERROR"
            ).model_dump()

    async def handle_get_usage_analytics(
        self, time_range_days: int = 30
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_error_response(
                f"Failed to get usage analytics: {str(e)}", "INTERNAL_ERROR"
            ).model_dump()
