...
class OptimizationHandlers(BaseHandler):
    ...
    async def handle_record_test_result(
        ...
        try:
            ...
            return create_success_response(message="Test result recorded successfully").model_dump()
        except Exception as e:
    ...
    async def handle_get_test_results(self, test_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if results:
                return create_success_response(message="Test results retrieved successfully", data=results).model_dump()
            else:
    ...
    async def handle_end_test(self, test_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_success_response(
                message="A/B test ended successfully", data={"test_id": test_id, "winner": winner}
            ).model_dump()
        except Exception as e:
    ...
    async def handle_run_optimization(self, prompt_id: str, base_version: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return create_success_response(message="Optimization cycle started successfully", data=cycle).model_dump()
        except Exception as e:
