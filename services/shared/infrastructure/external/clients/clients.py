...
try:
    ...
    from ...utilities.utilities import utc_now
except ImportError:
...
class ServiceClients:
    ...
    def consistency_engine_url(self) -> str:
        return get_config_value(
            ...
            section="services",
            env_key="CONSISTENCY_ENGINE_URL",
        )
    ...
    def notification_service_url(self) -> str:
        ...
        return get_config_value(
            ...
            "http://notification-service:5210",
            section="services",
            env_key="NOTIFICATION_SERVICE_URL",
        )

    async def notify_via_service(
        self,
        channel: str,
        target: str,
        title: str,
    ...
    async def _search_local(
        ...
        return {"status": "success", "data": {"items": results}}
    ...
    async def _get_style_examples_local(
        self, conn: sqlite3.Connection, params: Optional[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {"status": "success", "data": {"items": examples}}
