...
class WorkflowDispatcher:
    ...
    async def _get_match_reasons(
        self, query: str, intent: str, workflow_name: str, workflow_info: Dict[str, Any]
    ) -> List[str]:
    ...
    async def _map_entities_to_parameters(
        self, entities: Dict[str, Any], workflow_params: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _execute_workflow_with_orchestrator(
        self, execution_plan: Dict[str, Any], user_id: str = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if execution_method == "orchestrator_langgraph":
                ...
                result = await orchestrator_integration.execute_langgraph_workflow(
                    execution_plan["workflow_type"], parameters, user_id
                )
            else:
    ...
    async def _handle_no_workflow_match(
        self, query: str, intent: str, entities: Dict[str, Any], user_id: str = None
    ) -> Dict[str, Any]:
