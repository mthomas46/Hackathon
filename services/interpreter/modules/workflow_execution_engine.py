...
class WorkflowExecutionEngine:
    ...
    async def _prepare_conversation_updates(
        self, execution_context: Dict[str, Any], result: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _finalize_execution(self, execution_id: str, execution_result: Dict[str, Any]):
        ...
        if execution_id in self.active_executions:
            ...
            self.execution_metrics["average_execution_time"] = (
                current_avg * (total_execs - 1) + execution_duration
            ) / total_execs
            ...
            workflow_perf["average_duration"] = (
                workflow_avg * (workflow_execs - 1) + execution_duration
            ) / workflow_execs
    ...
    async def _handle_validation_failure(
        self, execution_context: Dict[str, Any], validation_result: Dict[str, Any]
    ) -> Dict[str, Any]:
