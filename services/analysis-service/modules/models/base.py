...
class SuccessResponse(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(
        default_factory=lambda: datetime.now(timezone.utc), description="When the response was generated"
    )
...
class RequestMetadata(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(
        default_factory=lambda: datetime.now(timezone.utc), description="When the request was made"
    )
...
class HealthStatus(BaseModel):
    ...
    last_check: Optional[datetime] = Field(
        default_factory=lambda: datetime.now(timezone.utc), description="When health was last checked"
    )
...
class AnalysisContext(BaseModel):
    ...
    created_at: Optional[datetime] = Field(
        default_factory=lambda: datetime.now(timezone.utc), description="When the analysis was initiated"
    )
