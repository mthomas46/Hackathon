    ...
    async def create_connection(self) -> sqlite3.Connection:
        ...
        def _create_conn():
            conn = sqlite3.connect(
                ...
                check_same_thread=False,  # We'll manage transactions manually
            )
...
class DatabasePoolFactory:
    ...
    @staticmethod
    def create_sqlite_pool(database_path: str, config: Optional[ConnectionPoolConfig] = None, **kwargs) -> SQLiteConnectionPool:
    ...
    @staticmethod
    def create_pool_from_url(connection_url: str, config: Optional[ConnectionPoolConfig] = None) -> DatabaseConnectionPool:
