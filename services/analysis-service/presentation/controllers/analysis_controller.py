...
class AnalysisController:
    ...
    def _setup_routes(self):
        ...
        async def analyze_documents(req: AnalysisRequest):
            """
            Analyze documents for consistency and issues with configurable
            detectors.

            Performs comprehensive document analysis using various
            detectors to identify consistency issues, quality problems,
            and maintenance concerns across multiple document sources
            and types.
            """
        ...
        async def analyze_semantic_similarity_endpoint(req: SemanticSimilarityRequest):
            ...
            Uses advanced embedding techniques to detect conceptually
            similar content across documents, helping identify
        ...
        async def analyze_sentiment_endpoint(req: SentimentAnalysisRequest):
            ...
            Evaluates the emotional tone and clarity of documentation to
            ensure professional communication and effective knowledge
            transfer.
            """
        ...
        async def analyze_tone_endpoint(req: ToneAnalysisRequest):
            ...
            Examines writing style, formality levels, and communication
            patterns to ensure consistent and appropriate documentation
            tone.
            """
        ...
        async def analyze_quality_endpoint(req: ContentQualityRequest):
            """
            Analyze content quality with comprehensive assessment and
            recommendations.

            Provides detailed quality assessment with actionable
            recommendations for improving documentation clarity,
        ...
        async def analyze_trends_endpoint(req: TrendAnalysisRequest):
            ...
            Identifies patterns in documentation evolution and predicts
            potential future issues based on historical trends and
            current state.
            """
        ...
        async def analyze_trends_portfolio_endpoint(req: PortfolioTrendAnalysisRequest):
            ...
            Performs comprehensive trend analysis across multiple
            documents to identify organizational patterns and predict
            future needs.
            """
        ...
        async def analyze_risk_endpoint(req: RiskAssessmentRequest):
            """
            Assess risk factors for documentation drift and quality
            degradation.

            Evaluates current documentation state against quality
            standards and identifies areas requiring immediate attention
        ...
        async def analyze_risk_portfolio_endpoint(req: PortfolioRiskAssessmentRequest):
            ...
            Performs comprehensive risk assessment across multiple
            documents to identify organizational risks and prioritize
            mitigation efforts.
            """
        ...
        async def analyze_maintenance_forecast_endpoint(req: MaintenanceForecastRequest):
            ...
            Predicts when documentation will require updates based on
            multiple factors including usage patterns, team size, and
            content complexity.
            """
        ...
        async def analyze_maintenance_forecast_portfolio_endpoint(req: PortfolioMaintenanceForecastRequest):
            ...
            Provides comprehensive maintenance forecasting across
            multiple documents to optimize resource allocation and
        ...
        async def analyze_quality_degradation_portfolio_endpoint(req: PortfolioQualityDegradationRequest):
            ...
            Provides comprehensive quality monitoring across multiple
            documents with pattern recognition and predictive alerting.
            """
        ...
        async def analyze_change_impact_endpoint(req: ChangeImpactAnalysisRequest):
            ...
            Evaluates how changes to specific documentation affect
            related content, stakeholders, and dependent systems to
        ...
        async def analyze_change_impact_portfolio_endpoint(req: PortfolioChangeImpactRequest):
            ...
            Performs comprehensive change impact analysis across
            multiple documents to understand the full scope of changes
