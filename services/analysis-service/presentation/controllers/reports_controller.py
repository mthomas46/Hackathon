...
class ReportsController:
    ...
    def _setup_routes(self):
        ...
        async def generate_reports_endpoint(req: ReportRequest):
            ...
            Generates comprehensive reports on documentation analysis
            results including quality metrics, trends, risk assessments,
            and recommendations.
            """
        ...
        async def get_detectors_endpoint():
            ...
            Returns comprehensive information about all available
            analysis detectors including their capabilities,
        ...
        async def get_confluence_consolidation_report_endpoint():
            """
            Analyze Confluence pages for duplicates and consolidation
            opportunities.

            Identifies duplicate content across Confluence pages and
            provides consolidation recommendations to improve
        ...
        async def get_jira_staleness_report_endpoint():
            ...
            Analyzes Jira tickets for staleness patterns and provides
            recommendations for ticket maintenance and cleanup to
            improve project tracking efficiency.
            """
        ...
        async def notify_findings_owners_endpoint(req: NotifyOwnersRequest):
            ...
            Automatically notifies document owners and stakeholders
            about analysis findings requiring their attention and
            action.
            """
