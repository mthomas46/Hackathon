...
class RemediationController:
    ...
    def _setup_routes(self):
        ...
        async def remediate_endpoint(req: AutomatedRemediationRequest):
            ...
            Applies automated fixes to common documentation problems
            including formatting inconsistencies, terminology issues,
            and structural problems. Provides detailed reports of
            changes made and recommendations for review.
            """
        ...
        async def remediate_preview_endpoint(req: RemediationPreviewRequest):
            ...
            Shows what changes would be made by automated remediation
            without actually applying them, allowing for review and
