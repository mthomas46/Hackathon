...
def sample_finding_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "metadata": {"rule_id": "TEST-001", "tags": ["test", "code_quality"]},
    }
...
def analysis_service(
    analysis_repository: AnalysisRepository, document_repository: DocumentRepository
) -> AnalysisService:
...
def file_location() -> FileLocation:
    ...
    return FileLocation(file_path="/src/main.py", line_number=42)
