...
class TestCompleteUserWorkflows:
    ...
    async def test_document_upload_and_analysis_workflow(self, client, sample_document_content):
        ...
        similarity_request = {
            ...
            "options": {"include_embeddings": False, "batch_size": 16},
        }
        ...
        sentiment_request = {
            "document_id": "workflow-doc-001",
            "analysis_options": {"include_detailed_scores": True, "language": "en"},
        }

        with patch(
            "services.analysis_service.presentation.controllers.analysis_controller.analysis_handlers.handle_sentiment_analysis"
        ) as mock_sentiment:
            mock_response = SentimentAnalysisResponse(
                ...
                detailed_analysis={
                    "sentence_sentiments": [
                        ...
                        {
                            "text": "Understanding its fundamentals is essential",
                            "sentiment": "positive",
                            "confidence": 0.85,
                        },
                    ],
        ...
        quality_request = {
            ...
            "options": {"language": "en", "readability_target": 70.0},
        }

        with patch(
            "services.analysis_service.presentation.controllers.analysis_controller.analysis_handlers.handle_content_quality_assessment"
        ) as mock_quality:
    ...
    async def test_error_recovery_workflow(self, client):
        ...
        similarity_request = {"targets": ["non-existent-doc"], "threshold": 0.8}
        ...
        valid_similarity_request = {"targets": ["recovery-doc"], "threshold": 0.8}
    ...
    async def test_distributed_processing_workflow(self, client):
        ...
        with patch(
            "services.analysis_service.presentation.controllers.distributed_controller.distributed_handlers.handle_get_task_status"
        ) as mock_status:
        ...
        with patch(
            "services.analysis_service.presentation.controllers.distributed_controller.distributed_handlers.handle_get_workers_status"
        ) as mock_workers:
    ...
    async def test_batch_processing_workflow(self, client):
        ...
        with patch(
            "services.analysis_service.presentation.controllers.distributed_controller.distributed_handlers.handle_submit_batch_tasks"
        ) as mock_batch:
        ...
        with patch(
            "services.analysis_service.presentation.controllers.distributed_controller.distributed_handlers.handle_get_processing_stats"
        ) as mock_stats:
        ...
        with patch(
            "services.analysis_service.presentation.controllers.distributed_controller.distributed_handlers.handle_get_queue_status"
        ) as mock_queue:
    ...
    async def test_workflow_with_findings_management(self, client):
        ...
        with patch(
            "services.analysis_service.presentation.controllers.findings_controller.findings_handlers.handle_export_findings"
        ) as mock_export:
    ...
    async def test_system_health_and_monitoring_workflow(self, client):
        ...
        with patch(
            "services.analysis_service.presentation.controllers.integration_controller.integration_handlers.handle_health_check"
        ) as mock_health:
        ...
        with patch(
            "services.analysis_service.presentation.controllers.integration_controller.integration_handlers.handle_get_api_analytics"
        ) as mock_analytics:
            mock_analytics.return_value = {
                ...
                "requests_by_user": {"user-1": 4520, "user-2": 3210, "user-3": 2890},
        ...
        with patch(
            "services.analysis_service.presentation.controllers.integration_controller.integration_handlers.handle_get_performance_metrics"
        ) as mock_metrics:
