...
class TestDTOValidation:
    ...
    def test_response_dto_headers(self):
        ...
        response = SuccessResponse(message="Success", request_id="req-123")
...
class TestDTOPagination:
    ...
    def test_pagination_edge_cases(self):
        ...
        # Empty result set
        response = PaginatedResponse(items=[], total_count=0, limit=10, offset=0)
    ...
    def test_pagination_with_invalid_data_raises_validation_error(self):
        ...
        response = PaginatedResponse(items=[], total_count=100, limit=-1, offset=0)

        assert response.is_valid_pagination() is False

        # Invalid pagination - negative offset
        response = PaginatedResponse(items=[], total_count=100, limit=50, offset=-10)
