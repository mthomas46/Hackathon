...
class TestPerformanceValidation:
    ...
    def test_resource_utilization_scaling(self):
        ...
        for load_level, results in scaling_results.items():
            ...
            assert (
                results["avg_time_per_operation"] < 1.0
            ...
            assert (
                results["operations_completed"] == load_level
    ...
    def test_error_rate_under_load(self):
        ...
        for target_error_rate in error_rates:
            ...
            assert (
                abs(actual_error_rate - target_error_rate) < error_tolerance
        ...
        for error_rate, results in error_results.items():
            if error_rate > 0:
                ...
                assert slowdown_ratio < 1.5, f"Error handling too slow at {error_rate} error rate: {slowdown_ratio:.2f}x slower"
    ...
    def test_cpu_utilization_under_load(self):
        ...
        for scenario in scenarios:
            ...
            # Validate CPU usage
            assert (
                cpu_percent <= scenario["expected_max_cpu"]
