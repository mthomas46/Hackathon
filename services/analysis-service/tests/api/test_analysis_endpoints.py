...
class TestAnalysisEndpoints:
    ...
    def sample_analysis_request(self):
        ...
        return AnalysisRequest(
            ...
            options={"threshold": 0.8, "include_details": True},
        )
    ...
    def sample_semantic_similarity_request(self):
        ...
        return SemanticSimilarityRequest(
            ...
            options={"include_embeddings": False, "batch_size": 32},
        )
    ...
    async def test_trend_analysis_success(self, client):
        ...
        with patch(
            "services.analysis_service.presentation.controllers.analysis_controller.analysis_handlers.handle_trend_analysis"
        ) as mock_handler:
    ...
    async def test_analysis_endpoint_concurrent_requests(self, client):
        ...
        async def make_request(request_id: int):
            request_data = {"targets": [f"doc-{request_id}"], "threshold": 0.8}
