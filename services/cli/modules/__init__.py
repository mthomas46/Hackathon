...
This package contains all the modularized functionality for the CLI
service. Provides shared utilities and client instances for all CLI
modules.
"""
...
__all__ = ["get_cli_client", "initialize_cli_client", "cli_client"]
