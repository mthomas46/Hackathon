...
class TestCLILoggingIntegration:
    ...
    def test_cli_startup_logging(self):
        ...
        startup_calls = [call for call in mock_logger_client.log_business_event.call_args_list
                        if call[0][0] == 'cli_service_startup']
    ...
    async def test_health_command_logging(self, runner):
        ...
        with patch('main.cli_service') as mock_cli_service:
            ...
            health_calls = [call for call in mock_logger_client.log_business_event.call_args_list
                          if 'health_check' in call[0][0]]
    ...
    async def test_interactive_command_logging_setup(self, runner):
        ...
        with patch('main.cli_service') as mock_cli_service, \
            ...
            interactive_calls = [call for call in mock_logger_client.log_business_event.call_args_list
                               if 'interactive_session' in call[0][0]]

            assert len(interactive_calls) >= 2  # started and completed

            # Check start event
            start_call = next((call for call in interactive_calls if call[0][0] == 'cli_interactive_session_started'), None)
            assert start_call is not None
            start_data = start_call[0][1]
            ...
            # Check completion event
            completion_call = next((call for call in interactive_calls if call[0][0] == 'cli_interactive_session_completed'), None)
            assert completion_call is not None
            completion_data = completion_call[0][1]
    ...
    async def test_interactive_command_keyboard_interrupt_logging(self, runner):
        ...
        with patch('main.cli_service') as mock_cli_service, \
            ...
            interrupt_calls = [call for call in mock_logger_client.log_business_event.call_args_list
    ...
    async def test_interactive_command_exception_logging(self, runner):
        ...
        with patch('main.cli_service') as mock_cli_service, \
            ...
            failure_calls = [call for call in mock_logger_client.log_business_event.call_args_list
    ...
    def test_session_id_generation(self, runner):
        ...
        with patch('main.cli_service') as mock_cli_service, \
            ...
            session_calls = [call for call in mock_logger_client.log_business_event.call_args_list
                           if 'session_id' in call[0][1]]
