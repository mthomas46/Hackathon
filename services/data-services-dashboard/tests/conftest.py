...
def mock_memory_client():
    ...
    client.search_memory_items = AsyncMock(return_value={
        "success": True,
        "items": []
    })
    return client
...
def mock_prompt_client():
    ...
    client.update_prompt = AsyncMock(return_value={
        "success": True,
        "message": "Prompt updated successfully"
    })
    client.delete_prompt = AsyncMock(return_value={
        "success": True,
...
def mock_streamlit(monkeypatch):
    ...
    mock_functions = [
        'markdown', 'header', 'subheader', 'text', 'code', 'json',
        'success', 'error', 'warning', 'info', 'button', 'checkbox',
        'text_input', 'text_area', 'selectbox', 'multiselect',
        'slider', 'columns', 'tabs', 'sidebar', 'expander',
        'dataframe', 'table', 'metric', 'progress', 'spinner',
        'empty', 'container', 'form', 'form_submit_button',
        'file_uploader', 'download_button', 'session_state',
