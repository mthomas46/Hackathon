...
class TestDomainApplicationIntegration:
    ...
    async def test_execute_simulation_integration(
        ...
        create_result = await application_service.create_simulation(
            {**sample_project_data, "team_members": sample_team_data}
        )
    ...
    @pytest.mark.asyncio
    async def test_domain_service_team_assignment_integration(
        self, domain_services, sample_project_data, sample_team_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_across_layers(self, repositories):
    ...
    @pytest.mark.asyncio
    async def test_caching_integration(self, repositories, sample_project_data):
    ...
    @pytest.mark.asyncio
    async def test_logging_integration(self, repositories, sample_project_data):
