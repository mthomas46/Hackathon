...
class WebSocketConnectionManager:
    ...
    async def _send_json_to_websocket(self, websocket: WebSocket, json_message: str) -> None:
        ...
        try:
            ...
            self.logger.warning("Failed to send WebSocket message", error=str(e))
...
class SimulationWebSocketHandler:
    ...
    async def handle_general_connection(self, websocket: WebSocket) -> None:
        ...
        try:
            ...
            self.logger.error("Error in general WebSocket handler", error=str(e))
        finally:
    ...
    async def notify_ecosystem_status(
        self, service_name: str, status: str, response_time: Optional[float] = None
    ) -> None:
    ...
    async def _subscribe_to_simulation_events(self, simulation_id: str) -> None:
        ...
        self.logger.info("Subscribed to simulation events", simulation_id=simulation_id)
