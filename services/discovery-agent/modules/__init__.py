...
Discovery Agent service. Provides shared utilities and client instances
for all discovery agent modules.
"""
...
__all__ = ["get_discovery_agent_client", "initialize_discovery_agent_client", "discovery_agent_client"]
