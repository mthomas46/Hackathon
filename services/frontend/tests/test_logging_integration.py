...
class TestFrontendLoggingIntegration:
    ...
    async def test_logs_dashboard_access_logging(self, client, mock_logger_client):
        ...
        with patch('main.ui_handlers') as mock_ui_handlers:
            ...
            access_events = [call for call in mock_logger_client.log_business_event.call_args_list
            ...
            render_events = [call for call in mock_logger_client.log_business_event.call_args_list
    ...
    async def test_logs_dashboard_failure_logging(self, client, mock_logger_client):
        ...
        with patch('main.ui_handlers') as mock_ui_handlers:
            ...
            dashboard_error = next((call for call in error_calls if 'Frontend logs dashboard rendering failed' in call[0][0]), None)
    ...
    async def test_api_logs_fetch_success_logging(self, client, mock_logger_client):
        ...
        with patch('main.fetch_logs_from_collector') as mock_fetch_logs:
            ...
            api_call_events = [call for call in mock_logger_client.log_business_event.call_args_list
            ...
            api_success_events = [call for call in mock_logger_client.log_business_event.call_args_list
    ...
    async def test_api_logs_fetch_failure_logging(self, client, mock_logger_client):
        ...
        with patch('main.fetch_logs_from_collector') as mock_fetch_logs:
            ...
            api_failure_events = [call for call in mock_logger_client.log_business_event.call_args_list
    ...
    async def test_different_api_endpoints_logging(self, client, mock_logger_client):
        ...
        for endpoint, expected_operation in endpoints_and_operations:
            # Mock the functions
            with patch('main.fetch_logs_from_collector') as mock_fetch_logs, \
                 patch('main.fetch_log_stats_from_collector') as mock_stats, \
                 patch('main.get_cached_logs_data') as mock_cache:
    ...
    async def test_logging_disabled_graceful_handling(self, client):
        ...
        # Mock the UI handlers
        with patch('main.ui_handlers') as mock_ui_handlers, \
             patch('main.fetch_logs_from_collector') as mock_fetch_logs:
