...
def get_orchestrator_url() -> str:
    ...
    return get_config_value(
        "ORCHESTRATOR_URL", "http://orchestrator:5040", section="services", env_key=_ORCHESTRATOR_URL_ENV
    )
...
def get_summarizer_hub_url() -> str:
    ...
    return get_config_value(
        "SUMMARIZER_HUB_URL", "http://summarizer-hub:5060", section="services", env_key=_SUMMARIZER_HUB_URL_ENV
    )
...
def get_log_collector_url() -> str:
    ...
    return get_config_value(
        "LOG_COLLECTOR_URL", "http://log-collector:5080", section="services", env_key=_LOG_COLLECTOR_URL_ENV
    )
...
def get_prompt_store_url() -> str:
    ...
    return get_config_value(
        "PROMPT_STORE_URL", "http://prompt-store:5110", section="services", env_key=_PROMPT_STORE_URL_ENV
    )
...
def get_analysis_service_url() -> str:
    ...
    return get_config_value(
        "ANALYSIS_SERVICE_URL", "http://analysis-service:5020", section="services", env_key=_ANALYSIS_SERVICE_URL_ENV
    )
...
def get_bedrock_proxy_url() -> str:
    ...
    return get_config_value(
        "BEDROCK_PROXY_URL", "http://bedrock-proxy:5000", section="services", env_key=_BEDROCK_PROXY_URL_ENV
    )
...
def get_code_analyzer_url() -> str:
    ...
    return get_config_value(
        "CODE_ANALYZER_URL", "http://code-analyzer:5030", section="services", env_key=_CODE_ANALYZER_URL_ENV
    )
...
def get_discovery_agent_url() -> str:
    ...
    return get_config_value(
        "DISCOVERY_AGENT_URL", "http://discovery-agent:5070", section="services", env_key=_DISCOVERY_AGENT_URL_ENV
    )
...
def get_interpreter_url() -> str:
    ...
    return get_config_value(
        "INTERPRETER_URL", "http://interpreter:5100", section="services", env_key=_INTERPRETER_URL_ENV
    )
...
def get_memory_agent_url() -> str:
    ...
    return get_config_value(
        "MEMORY_AGENT_URL", "http://memory-agent:5120", section="services", env_key=_MEMORY_AGENT_URL_ENV
    )
...
def get_secure_analyzer_url() -> str:
    ...
    return get_config_value(
        "SECURE_ANALYZER_URL", "http://secure-analyzer:5140", section="services", env_key=_SECURE_ANALYZER_URL_ENV
    )
...
def get_source_agent_url() -> str:
    ...
    return get_config_value(
        "SOURCE_AGENT_URL", "http://source-agent:5150", section="services", env_key=_SOURCE_AGENT_URL_ENV
    )
...
def fetch_service_data(
    ...
    try:
        ...
        raise ServiceException(
            ...
            details={"service": service_name, "endpoint": endpoint, "full_url": full_url, "error": str(e)},
        )
