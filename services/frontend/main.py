...
async def info():
    ...
    try:
        ...
        return handle_frontend_error(
            "get service info", e, **build_frontend_context("get_info")
        )
...
async def config_effective():
    ...
    try:
        ...
        return create_frontend_success_response(
            "config retrieved", config, **build_frontend_context("get_config")
        )
    except Exception as e:
        return handle_frontend_error(
            "get effective config", e, **build_frontend_context("get_config")
        )
...
async def metrics():
    ...
    try:
        return create_frontend_success_response(
            "metrics retrieved",
            {"service": config.service_name, "routes": len(app.routes)},
            **build_frontend_context("get_metrics"),
        )
    except Exception as e:
        return handle_frontend_error(
            "get metrics", e, **build_frontend_context("get_metrics")
        )
...
async def ui_jira_staleness(
    ...
    """
    return ui_handlers.handle_jira_staleness(
...
async def get_workflows_jobs_status():
    ...
    try:
        ...
        try:
            saga_stats = await clients.get_json(
                f"{orchestrator_url}/infrastructure/saga/stats"
            )
        ...
        try:
            ...
            status_data["infrastructure"]["services"] = registry_response.get(
                "services", []
            )
        except Exception as e:
        ...
        try:
            ...
            status_data["performance"]["orchestrator"] = metrics_response.get(
                "data", {}
            )
        except Exception as e:
        ...
        status_data["summary"] = {
            "total_workflows_available": len(
                status_data["workflows"].get("available", {})
            ),
            "active_workflows": len(
                [
                    w
                    for w in status_data["workflows"].get("history", [])
    ...
    try:
        ...
        status_data = {
            ...
            "summary": {
                ...
                "service_healthy": live_data["service_status"].get("status")
                == "healthy",
            },
        }
...
async def get_logs_status():
    ...
    try:
        ...
        return handle_frontend_error(
            "get logs status", e, **build_frontend_context("get_logs_status")
        )
...
async def fetch_logs(
    ...
    try:
        ...
        return handle_frontend_error(
            "fetch logs", e, **build_frontend_context("fetch_logs")
        )
...
async def stream_logs_endpoint(
    ...
    async def generate():
        try:
            async for log_entry in stream_logs(
                service=service, level=level, poll_interval=poll_interval
            ):
            ...
            error_data = json.dumps(
                {"error": str(e), "level": "error", "service": "frontend"}
            )
...
async def get_logs_stats():
    ...
    try:
        ...
        return handle_frontend_error(
            "get logs stats", e, **build_frontend_context("get_logs_stats")
        )
...
async def get_doc_store_status():
    ...
    try:
        ...
        return handle_frontend_error(
            "get doc_store status", e, **build_frontend_context("get_doc_store_status")
        )
...
async def get_doc_store_documents(
    ...
    try:
        result = await data_browser.get_doc_store_documents(
            limit=limit, offset=offset, force_refresh=force_refresh
        )
...
async def get_doc_store_style_examples(force_refresh: bool = False):
    ...
    """
    try:
        result = await data_browser.get_doc_store_style_examples(
            force_refresh=force_refresh
        )
...
async def search_doc_store(q: str, limit: int = 20):
    ...
    try:
        ...
        return handle_frontend_error(
            "search doc_store", e, **build_frontend_context("search_doc_store")
        )
...
async def get_prompt_store_analytics(force_refresh: bool = False):
    ...
    """
    try:
        result = await data_browser.get_prompt_store_analytics(
            force_refresh=force_refresh
        )
...
async def get_orchestrator_config(force_refresh: bool = False):
    ...
    """
    try:
        config_data = await orchestrator_monitor.get_orchestrator_config(
            force_refresh=force_refresh
        )
...
async def get_orchestrator_redis_activity(force_refresh: bool = False):
    ...
    """
    try:
        activity_data = await orchestrator_monitor.get_redis_pubsub_activity(
            force_refresh=force_refresh
        )
        ...
        return handle_frontend_error(
            "get orchestrator Redis activity",
            e,
            **build_frontend_context("get_orchestrator_redis_activity"),
        )
...
async def get_orchestrator_workflows(force_refresh: bool = False):
    ...
    """
    try:
        workflow_data = await orchestrator_monitor.get_orchestrator_workflows(
            force_refresh=force_refresh
        )
...
async def get_analysis_status():
    ...
    try:
        ...
        return handle_frontend_error(
            "get analysis status", e, **build_frontend_context("get_analysis_status")
        )
...
async def get_analysis_result(analysis_id: str):
    ...
    try:
        ...
        return handle_frontend_error(
            "get analysis result", e, **build_frontend_context("get_analysis_result")
        )
...
async def run_analysis_endpoint(analysis_request: dict):
    ...
    try:
        ...
        return create_frontend_success_response(
            status_message, result, **build_frontend_context("run_analysis")
        )

    except Exception as e:
        return handle_frontend_error(
            "run analysis", e, **build_frontend_context("run_analysis")
        )
...
async def get_analysis_report(report_type: str):
    ...
    try:
        ...
        return handle_frontend_error(
            "get analysis report", e, **build_frontend_context("get_analysis_report")
        )
...
async def get_analysis_history(limit: int = 20):
    ...
    try:
        ...
        return handle_frontend_error(
            "get analysis history", e, **build_frontend_context("get_analysis_history")
        )
...
async def get_finding_details(finding_id: str):
    ...
    try:
        ...
        return handle_frontend_error(
            "get finding details", e, **build_frontend_context("get_finding_details")
        )
...
async def get_code_analyzer_status():
    ...
    try:
        ...
        return create_frontend_success_response(
            ...
            status_data,
            **build_frontend_context("get_code-analyzer_status"),
        )
    except Exception as e:
        return handle_frontend_error(
...
async def analyze_text_code(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "analyze text code", e, **build_frontend_context("analyze_text_code")
        )
...
async def analyze_files_code(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "analyze files code", e, **build_frontend_context("analyze_files_code")
        )
...
async def security_scan_code(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "security scan code", e, **build_frontend_context("security_scan_code")
        )
...
async def style_check_code(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "style check code", e, **build_frontend_context("style_check_code")
        )
...
async def get_style_examples():
    ...
    try:
        ...
        return handle_frontend_error(
            "get style examples", e, **build_frontend_context("get_style_examples")
        )
...
async def get_code_analyzer_history():
    ...
    try:
        ...
        return create_frontend_success_response(
            ...
            {"history": history},
            **build_frontend_context("get_code-analyzer_history"),
        )
    except Exception as e:
        return handle_frontend_error(
            "get code analyzer history",
            e,
            **build_frontend_context("get_code-analyzer_history"),
        )
...
async def invoke_bedrock_proxy(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "invoke bedrock proxy", e, **build_frontend_context("invoke_bedrock_proxy")
        )
...
async def get_github_mcp_tools(toolsets: Optional[str] = None):
    ...
    try:
        ...
        return handle_frontend_error(
            "get github-mcp tools", e, **build_frontend_context("get_github_mcp_tools")
        )
...
async def interpret_query(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "interpret query", e, **build_frontend_context("interpret_query")
        )
...
async def get_memory_agent_items(
    type: Optional[str] = None, key: Optional[str] = None, limit: int = 25
):
    ...
    try:
        ...
        items = await memory_agent_monitor.list_memory_items(
            type=type, key=key, limit=limit
        )
        return create_frontend_success_response(
...
async def store_memory_agent_item(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "store memory item", e, **build_frontend_context("store_memory_agent_item")
        )
...
async def get_notification_service_status():
    ...
    try:
        ...
        return create_frontend_success_response(
            ...
            status_data,
            **build_frontend_context("get_notification-service_status"),
        )
    except Exception as e:
        return handle_frontend_error(
...
async def get_notification_dlq(limit: int = 50):
    ...
    try:
        ...
        return handle_frontend_error(
            "get notification DLQ", e, **build_frontend_context("get_notification_dlq")
        )
...
async def resolve_notification_owners(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "resolve owners", e, **build_frontend_context("resolve_notification_owners")
        )
...
async def send_test_notification(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "send notification", e, **build_frontend_context("send_test_notification")
        )
...
async def get_secure_analyzer_status():
    ...
    try:
        ...
        return create_frontend_success_response(
            ...
            status_data,
            **build_frontend_context("get_secure-analyzer_status"),
        )
    except Exception as e:
        return handle_frontend_error(
            "get secure analyzer status",
            e,
            **build_frontend_context("get_secure-analyzer_status"),
        )
...
async def detect_secure_content(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "detect content", e, **build_frontend_context("detect_secure_content")
        )
...
async def suggest_secure_models(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "suggest models", e, **build_frontend_context("suggest_secure_models")
        )
...
async def get_summary_history(limit: int = 20):
    ...
    try:
        ...
        return handle_frontend_error(
            "get summary history", e, **build_frontend_context("get_summary_history")
        )
...
async def get_source_agent_status():
    ...
    try:
        ...
        return create_frontend_success_response(
            ...
            status_data,
            **build_frontend_context("get_source-agent_status"),
        )
    except Exception as e:
        return handle_frontend_error(
            "get source agent status",
            e,
            **build_frontend_context("get_source-agent_status"),
        )
...
async def fetch_source_document(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "fetch document", e, **build_frontend_context("fetch_source_document")
        )
...
async def normalize_source_data(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "normalize data", e, **build_frontend_context("normalize_source_data")
        )
...
async def analyze_source_code(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "analyze code", e, **build_frontend_context("analyze_source_code")
        )
...
async def get_fetch_history(limit: int = 20):
    ...
    try:
        ...
        return handle_frontend_error(
            "get fetch history", e, **build_frontend_context("get_fetch_history")
        )
...
async def get_service_health_details(service_name: str):
    ...
    try:
        ...
        health_data = await services_overview_monitor.get_service_health_details(
            service_name
        )
        return create_frontend_success_response(
...
async def get_cli_status():
    ...
    try:
        ...
        return handle_frontend_error(
            "get CLI status", e, **build_frontend_context("get_cli_status")
        )
...
async def execute_cli_command(req: dict):
    ...
    try:
        ...
        return handle_frontend_error(
            "execute CLI command", e, **build_frontend_context("execute_cli_command")
        )
...
async def get_cli_commands():
    ...
    try:
        ...
        return handle_frontend_error(
            "get CLI commands", e, **build_frontend_context("get_cli_commands")
        )
...
async def get_cli_prompts(category: Optional[str] = None):
    ...
    try:
        ...
        return handle_frontend_error(
            "get prompts via CLI", e, **build_frontend_context("get_cli_prompts")
        )


@app.get("/api/cli/prompts/{category}/{name}")
async def get_cli_prompt_details(
    category: str, name: str, content: Optional[str] = None
):
    ...
    try:
        ...
        result = await cli_monitor.get_prompt_details(
