...
class TestDocument:
    ...
    def test_document_recent_check(self):
        """Test document recency checking."""
        recent_doc = Document(
            source_type="github",
            source_id="repo/docs",
    ...
    def test_document_properties(self):
        ...
        assert doc.content_length == len(doc.content)
        assert doc.has_metadata is True

        empty_metadata_doc = Document(
            source_type="github",
            source_id="repo/docs",
            title="Empty Metadata",
            content="Content"
        )
        assert empty_metadata_doc.has_metadata is False
