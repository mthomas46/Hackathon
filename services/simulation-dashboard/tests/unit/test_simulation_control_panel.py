...
from pages.controls import (
    ...
    update_simulation_priority,
    update_simulation_resources,
)
...
class TestControlPanel:
    ...
    def test_execute_control_action_success(self, mock_get_details, mock_st):
        ...
        # Mock session state
        mock_st.session_state = {"control_operations": []}
    ...
    def test_update_simulation_resources(self, mock_st):
        ...
        mock_st.success.assert_called_once_with(
            "✅ Resources updated - CPU: 80%, Memory: 1024MB for simulation sim_001"
        )
