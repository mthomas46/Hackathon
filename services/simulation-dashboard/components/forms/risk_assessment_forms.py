...
def render_risk_assessment_form(
    ...
    risk_factors = {
        ...
        "budget_contingency": {
            ...
            "options": [
                "Strong Contingency (>25%)",
                "Adequate Contingency (15-25%)",
                "Minimal Contingency (5-15%)",
                "No Contingency",
            ],
            "weights": {
                "Strong Contingency (>25%)": 0,
                "Adequate Contingency (15-25%)": 1,
                "Minimal Contingency (5-15%)": 2,
                "No Contingency": 3,
            },
        },
