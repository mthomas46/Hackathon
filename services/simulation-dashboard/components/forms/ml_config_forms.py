...
def render_ml_config_form(
    ...
    with col1:
        ...
        selected_algorithm = st.selectbox(
            ...
            index=(
                available_algorithms.index(config.get("algorithm", "Random Forest"))
                if config.get("algorithm") in available_algorithms
                else 0
            ),
        ...
        problem_type = st.selectbox(
            ...
            index=["Regression", "Classification", "Time Series", "Clustering"].index(
