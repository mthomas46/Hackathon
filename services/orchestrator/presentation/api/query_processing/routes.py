...
async def process_natural_language_query(request: ProcessQueryRequest):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("natural_language_query_started", {
            ...
            await logger.log_info("Processing natural language query", {
                "request_id": request_id,
                "query_preview": request.query_text[:100] + "..." if len(request.query_text or "") > 100 else request.query_text,
        ...
        if logger:
            await logger.log_business_event("natural_language_query_completed", {
                "request_id": request_id,
                "operation": "natural_language_query_processing",
        ...
        if logger:
            ...
            await logger.log_business_event("natural_language_query_failed", {
                "request_id": request_id,
                "operation": "natural_language_query_processing",
                "error_type": type(e).__name__,
                "error_message": str(e),
...
async def execute_structured_query(request: StructuredQueryRequest):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("structured_query_started", {
                "request_id": request_id,
            ...
            await logger.log_info("Executing structured query", {
                "request_id": request_id,
                "query_type": request.query_type,
        ...
        if logger:
            await logger.log_business_event("structured_query_completed", {
                "request_id": request_id,
                "operation": "structured_query_execution",
                "response_time_seconds": response_time,
                "success": True,
        ...
        if logger:
            ...
            await logger.log_business_event("structured_query_failed", {
                "request_id": request_id,
                "operation": "structured_query_execution",
                "query_type": request.query_type,
                "error_type": type(e).__name__,
...
async def get_query_result(query_id: str):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("query_result_retrieval_started", {
                "request_id": request_id,
                "query_id": query_id,
            ...
            await logger.log_info("Retrieving stored query result", {
                "request_id": request_id,
                "query_id": query_id,
        ...
        if not result:
            ...
            if logger:
                await logger.log_business_event("query_result_not_found", {
                    "request_id": request_id,
                    "query_id": query_id,
                    "operation": "query_result_access",
                    "response_time_seconds": response_time,
        ...
        if logger:
            await logger.log_business_event("query_result_retrieved", {
                "request_id": request_id,
                "query_id": query_id,
                "operation": "query_result_access",
                "response_time_seconds": response_time,
        ...
        if logger:
            ...
            await logger.log_business_event("query_result_retrieval_failed", {
                "request_id": request_id,
                "operation": "query_result_access",
                "query_id": query_id,
                "error_type": type(e).__name__,
...
async def list_query_history(
    ...
    try:
        ...
        if logger:
            ...
            await logger.log_business_event("query_history_listing_started", {
                "request_id": request_id,
            ...
            await logger.log_info("Listing query execution history", {
                "request_id": request_id,
        ...
        if logger:
            await logger.log_business_event("query_history_listed", {
                "request_id": request_id,
                "operation": "query_execution_history",
                "response_time_seconds": response_time,
                "success": True,
        ...
        if logger:
            ...
            await logger.log_business_event("query_history_listing_failed", {
                "request_id": request_id,
                "operation": "query_execution_history",
                "error_type": type(e).__name__,
                "error_message": str(e),
...
async def get_query_history(query_id: str):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("query_history_detail_started", {
                "request_id": request_id,
                "query_id": query_id,
            ...
            await logger.log_info("Retrieving detailed query history", {
                "request_id": request_id,
                "query_id": query_id,
        ...
        if not result:
            ...
            if logger:
                await logger.log_business_event("query_history_not_found", {
                    "request_id": request_id,
                    "query_id": query_id,
                    "operation": "detailed_query_history",
                    "response_time_seconds": response_time,
        ...
        if logger:
            await logger.log_business_event("query_history_detail_retrieved", {
                "request_id": request_id,
                "query_id": query_id,
                "operation": "detailed_query_history",
                "response_time_seconds": response_time,
        ...
        if logger:
            ...
            await logger.log_business_event("query_history_detail_failed", {
                "request_id": request_id,
                "operation": "detailed_query_history",
                "query_id": query_id,
                "error_type": type(e).__name__,
...
async def list_query_intents():
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("query_intents_listing_started", {
                "request_id": request_id,
            ...
            await logger.log_info("Listing available query intents and capabilities", {
                "request_id": request_id,
        ...
        if logger:
            await logger.log_business_event("query_intents_listed", {
                "request_id": request_id,
                "operation": "query_capability_discovery",
                "response_time_seconds": response_time,
                "success": True,
        ...
        if logger:
            ...
            await logger.log_business_event("query_intents_listing_failed", {
                "request_id": request_id,
                "operation": "query_capability_discovery",
                "error_type": type(e).__name__,
                "error_message": str(e),
...
async def delete_query_result(query_id: str):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("query_result_deletion_started", {
                "request_id": request_id,
                "query_id": query_id,
            ...
            await logger.log_info("Initiating query result deletion", {
                "request_id": request_id,
                "query_id": query_id,
        ...
        if logger:
            await logger.log_business_event("query_result_deletion_not_implemented", {
                "request_id": request_id,
                "query_id": query_id,
                "operation": "query_result_management",
                "response_time_seconds": response_time,
        ...
        if logger:
            ...
            await logger.log_business_event("query_result_deletion_failed", {
                "request_id": request_id,
                "operation": "query_result_management",
                "query_id": query_id,
                "error_type": type(e).__name__,
...
async def get_query_stats():
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("query_stats_retrieval_started", {
                "request_id": request_id,
            ...
            await logger.log_info("Retrieving query processing statistics", {
                "request_id": request_id,
        ...
        if logger:
            await logger.log_business_event("query_stats_retrieved", {
                "request_id": request_id,
                "operation": "query_system_monitoring",
                "response_time_seconds": response_time,
                "success": True,
        ...
        if logger:
            ...
            await logger.log_business_event("query_stats_retrieval_failed", {
                "request_id": request_id,
                "operation": "query_system_monitoring",
                "error_type": type(e).__name__,
                "error_message": str(e),
