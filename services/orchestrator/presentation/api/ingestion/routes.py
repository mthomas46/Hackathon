...
async def start_ingestion(request: IngestRequest):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("ingestion_workflow_started", {
            ...
            await logger.log_info("Starting document ingestion workflow", {
                "request_id": request_id,
                "source_url": request.source_url,
                "source_type": request.source_type,
        ...
        if logger:
            await logger.log_business_event("ingestion_workflow_created", {
                "request_id": request_id,
        ...
        if logger:
            ...
            await logger.log_business_event("ingestion_workflow_creation_failed", {
                "request_id": request_id,
                "operation": "document_ingestion_workflow",
                "error_type": type(e).__name__,
                "error_message": str(e),
...
async def get_ingestion_status(ingestion_id: str):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("ingestion_status_retrieval_started", {
                "request_id": request_id,
                "ingestion_id": ingestion_id,
            ...
            await logger.log_info("Retrieving ingestion workflow status", {
                "request_id": request_id,
                "ingestion_id": ingestion_id,
        ...
        if not result:
            ...
            if logger:
                await logger.log_business_event("ingestion_not_found", {
                    "request_id": request_id,
                    "ingestion_id": ingestion_id,
                    "operation": "ingestion_workflow_monitoring",
                    "response_time_seconds": response_time,
        ...
        if logger:
            await logger.log_business_event("ingestion_status_retrieved", {
                "request_id": request_id,
                "ingestion_id": ingestion_id,
                "operation": "ingestion_workflow_monitoring",
                "response_time_seconds": response_time,
        ...
        if logger:
            ...
            await logger.log_business_event("ingestion_status_retrieval_failed", {
                "request_id": request_id,
                "operation": "ingestion_workflow_monitoring",
                "ingestion_id": ingestion_id,
                "error_type": type(e).__name__,
...
async def list_ingestions(
    ...
    try:
        ...
        if logger:
            ...
            await logger.log_business_event("ingestion_listing_started", {
                "request_id": request_id,
            ...
            await logger.log_info("Listing ingestion workflows", {
                "request_id": request_id,
        ...
        if logger:
            await logger.log_business_event("ingestion_listing_completed", {
                "request_id": request_id,
                "operation": "ingestion_workflow_inventory",
                "response_time_seconds": response_time,
                "success": True,
        ...
        if logger:
            ...
            await logger.log_business_event("ingestion_listing_failed", {
                "request_id": request_id,
                "operation": "ingestion_workflow_inventory",
                "error_type": type(e).__name__,
                "error_message": str(e),
...
async def get_document_metadata(document_id: str):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("document_metadata_retrieval_started", {
                "request_id": request_id,
            ...
            await logger.log_info("Retrieving document metadata from ingestion results", {
                "request_id": request_id,
                "document_id": document_id,
        ...
        if logger:
            await logger.log_business_event("document_metadata_not_implemented", {
                "request_id": request_id,
                "document_id": document_id,
                "operation": "ingested_document_metadata",
                "response_time_seconds": response_time,
        ...
        if logger:
            ...
            await logger.log_business_event("document_metadata_retrieval_failed", {
                "request_id": request_id,
                "operation": "ingested_document_metadata",
                "document_id": document_id,
                "error_type": type(e).__name__,
...
async def list_ingestion_sources():
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("ingestion_sources_listing_started", {
                "request_id": request_id,
            ...
            await logger.log_info("Listing available ingestion sources and capabilities", {
                "request_id": request_id,
        ...
        if logger:
            await logger.log_business_event("ingestion_sources_listed", {
                "request_id": request_id,
                "operation": "ingestion_capability_discovery",
                "response_time_seconds": response_time,
                "success": True,
        ...
        if logger:
            ...
            await logger.log_business_event("ingestion_sources_listing_failed", {
                "request_id": request_id,
                "operation": "ingestion_capability_discovery",
                "error_type": type(e).__name__,
                "error_message": str(e),
...
async def cancel_ingestion(ingestion_id: str):
    ...
    try:
        ...
        if logger:
            await logger.log_business_event("ingestion_cancellation_started", {
                "request_id": request_id,
                "ingestion_id": ingestion_id,
            ...
            await logger.log_info("Initiating ingestion workflow cancellation", {
                "request_id": request_id,
                "ingestion_id": ingestion_id,
        ...
        if logger:
            await logger.log_business_event("ingestion_cancellation_not_implemented", {
                "request_id": request_id,
                "ingestion_id": ingestion_id,
                "operation": "ingestion_workflow_control",
                "response_time_seconds": response_time,
        ...
        if logger:
            ...
            await logger.log_business_event("ingestion_cancellation_failed", {
                "request_id": request_id,
                "operation": "ingestion_workflow_control",
                "ingestion_id": ingestion_id,
                "error_type": type(e).__name__,
