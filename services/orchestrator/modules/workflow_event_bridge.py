...
from .event_driven_orchestration import EventType, WorkflowEvent, event_store
...
async def emit_step_event(
    ...
    """Emit workflow step event."""
    return await workflow_event_bridge.emit_step_event(
        workflow_id, execution_id, step_id, step_name, status, data, user_id
    )
