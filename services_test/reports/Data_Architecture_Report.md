...
- **8 Services** discovered from 9 historical documents
- **31 Document-Service Linkings** created
...
**Current Data:**
- **Jira Tickets:** 1 documents
- **Confluence Docs:** 1 documents
- **GitHub PRs:** 2 documents
- **Total:** 4 documents
...
**Current Data:**
- **Services Discovered:** 8 services
- **Services Stored:** 8 services
- **Document Links:** 31 linkings
...
- **GitHub → Services:** 2 linkings
- **Total Links:** 31 linkings
...
- Documents Analyzed: 2 GitHub PRs, 1 Jira tickets, 1 Confluence docs
- Users Extracted: 3 unique users
...
|-------|-----------|-------|--------|
| **doc_store** | Historical Documents | 4 | ✅ |
| **prompt_store** | Workflow Prompts | 8 | ✅ |
| **external-service-store** | Discovered Services | 8 | ✅ |
...
- **8 services** discovered from 9 documents
- **31 total mentions** across all documents
- **8 unique services** cataloged
- **31 document-service linkings** established
