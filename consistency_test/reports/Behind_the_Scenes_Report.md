...
| Parameter | Value |
|-----------|-------|
| **Feature Request** | Consistency Test... |
...
```
consistency_test/data/mock_data.json
```
...
- **Total Users Extracted:** 2
- **Subject Matter Experts:** 2
- **Collaboration Relationships:** 2
- **User-Store Integration:** 2 users persisted
...
| **F** | Users Extracted | 2 |
| **F** | SMEs Identified | 2 |
| **F** | Collaboration Relationships | 2 |
