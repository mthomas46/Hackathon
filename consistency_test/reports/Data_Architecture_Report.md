...
- **7 Services** discovered from 8 historical documents
- **29 Document-Service Linkings** created
...
- **Confluence → Services:** 3 linkings
- **GitHub → Services:** 1 linkings
- **Total Links:** 29 linkings
...
- Documents Analyzed: 1 GitHub PRs, 1 Jira tickets, 1 Confluence docs
- Users Extracted: 2 unique users
...
- **Services Stored:** 7
- **Document-Service Links:** 29
- **Discovery Confidence:** 0.99
...
- **7 services** discovered from 8 documents
- **29 total mentions** across all documents
- **7 unique services** cataloged
- **29 document-service linkings** established
