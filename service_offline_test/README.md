...
- Jira tickets: 1 tickets (30%)
- Confluence docs: 1 documents (30%)
- GitHub PRs: 2 pull requests (40%)
- **Total:** 4 documents
...
| **Total Historical Documents** | 5 (30% Jira, 30% Confluence, 40% GitHub) |
| **Tangential Service Docs** | 5 |
| **Team Members** | 6 |
| **Tech Stack** | Python, React, PostgreSQL |
| **Output Folder** | `service_offline_test/` |
