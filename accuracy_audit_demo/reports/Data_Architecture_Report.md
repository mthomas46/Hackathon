...
- **17 Services** discovered from 30 historical documents
- **78 Document-Service Linkings** created
...
**Current Data:**
- **Jira Tickets:** 6 documents
- **Confluence Docs:** 6 documents
- **GitHub PRs:** 8 documents
- **Total:** 20 documents
...
**Current Data:**
- **Services Discovered:** 17 services
- **Services Stored:** 17 services
- **Document Links:** 78 linkings
...
- **Confluence → Services:** 23 linkings
- **GitHub → Services:** 5 linkings
- **Total Links:** 78 linkings
...
- Users Extracted: 14 unique users
...
|-------|-----------|-------|--------|
| **doc_store** | Historical Documents | 20 | ✅ |
| **prompt_store** | Workflow Prompts | 8 | ✅ |
| **external-service-store** | Discovered Services | 17 | ✅ |
...
After Demo Run:
  doc_store: 20 documents (+20)
  prompt_store: 8 prompts (+8)
  external-service-store: 17 services (+17)
...
- **17 services** discovered from 30 documents
- **78 total mentions** across all documents
- **17 unique services** cataloged
- **78 document-service linkings** established
