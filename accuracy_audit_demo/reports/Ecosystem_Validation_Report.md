...
Timestamp: 2025-10-04T06:54:52.876043
...
Timestamp: 2025-10-04T06:54:52.876344
Proof Type: LIVE_MODULE_IMPORT
```
...
Line: 119
Timestamp: 2025-10-04T06:54:53.555503
...
Line: 1358
Timestamp: 2025-10-04T06:54:53.555521

Arguments:
{
  "feature_query": "Build microservices platform with API gateway, ser",
  "tech_stack": [
    "Python",
    "FastAPI",
    "Kubernetes",
...
python demo_hyper_realistic_parameterized.py \
  --feature "Build microservices platform with API gateway, service mesh,..." \
  --tickets 20 \
  --team 8 \
  --tech Python FastAPI Kubernetes \
  --output accuracy_audit_demo
```
...
- ✅ Users extracted: 14 unique users (if Workflow F executed)
