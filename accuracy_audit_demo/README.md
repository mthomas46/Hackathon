...
- Jira tickets: 6 tickets (30%)
- Confluence docs: 6 documents (30%)
- GitHub PRs: 8 pull requests (40%)
- **Total:** 20 documents
...
| **Total Historical Documents** | 20 (30% Jira, 30% Confluence, 40% GitHub) |
| **Tangential Service Docs** | 15 |
| **Team Members** | 8 |
| **Tech Stack** | Python, FastAPI, Kubernetes, Docker, PostgreSQL, Redis, Prometheus, Grafana, Terraform |
| **Output Folder** | `accuracy_audit_demo/` |
