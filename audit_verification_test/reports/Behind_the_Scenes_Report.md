...
| Parameter | Value |
|-----------|-------|
| **Feature Request** | Test audit implementation verification... |
...
| **Demo Folder** | `audit_verification_test/` |
...
**Historical Documents: 3 documents**
- 1 Jira tickets (30% of total parameter)
- 1 Confluence documents (30% of total parameter)
- 1 GitHub PRs (40% of total parameter)
...
**Total Documents for Analysis: 8**
...
The average estimate accuracy of 95.0%
indicates team estimation reliability.

#### Confluence Documents (1 docs)
...
**Team Velocity:** 17.2 SP/sprint (average)
...
```
audit_verification_test/data/mock_data.json
```
...
| **B** | Historical Context | 17 SP/sprint velocity | (parallel) |
...
- **Tangential Service Docs:** 5 external service documents
- **Total Documents Analyzed:** 8 documents (3 historical + 5 tangential)
...
**Team Composition:**
- 4 members
- Average Velocity: 17 SP/sprint
- Skills Coverage: 96.0%
- Team Utilization: 74.0%

**Historical Performance:**
- 1 Jira tickets analyzed
- 1 Confluence documents reviewed
- 1 GitHub PRs analyzed
- Average Estimate Accuracy: 95.0%
...
| Metric | Value |
|--------|-------|
| **Unique Users Extracted** | 2 users |
| **Documents Processed** | 3 documents |
| **SMEs Identified** | 2 experts |
| **Collaboration Relationships** | 2 relationships |
| **Expertise Topics** | 2 topics |
| **Execution Time** | 0.00s |
...
|--------------|-----------|----------------------|-----------------|
| **GitHub PRs** | 1 | ~2 | Author, Reviewers, Assignees, Merger, Commit Authors, Commenters |
| **Jira Tickets** | 1 | ~2 | Reporter, Assignee, Watchers, Worklog Contributors, Commenters |
| **Confluence Docs** | 1 | ~2 | Author, Editors, Maintainers, Watchers, Commenters |

**Total Unique Users After Deduplication**: 2
...
2. **Sarah Chen**: 2 interactions, topics: Python, React
...
- **Participants**: Team Member 1 ↔ Sarah Chen
...
- **Sarah Chen**: Confidence 0.07, 0 contributions
...
- ⚠️ **Expert-finder service offline** (unable to query for experts)
  - **Impact**: Expert discovery features unavailable
- ✅ **Planning service architecture supports expert-finder** (integration points defined)
  - ⚠️ **Note**: Section 10 recommendations are aspirational (no live data)
...
- ✅ Extracted 2 unique users from 3 documents
- ✅ Identified 2 subject matter experts
- ✅ Built collaboration graph with 2 relationships
- ✅ Mapped expertise across 2 topics
- ✅ Executed in 0.00s
