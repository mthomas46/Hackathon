...
| **Demo Folder** | `scala_elm_crud_demo_v8/` |
...
```
scala_elm_crud_demo_v8/data/mock_data.json
```
...
| **E** | External Service Validation | 95% final confidence | 0.01s |
...
**Store Accessibility:**
- doc_store: ⚠️ Not Running
- prompt_store: ⚠️ Not Running
