...
class ConfigTransitionAuditor:
    ...
    def generate_transition_report(self, results: Dict[str, Dict]) -> str:
        ...
        report.append(f"- **Services with config files:** {services_with_config} ({services_with_config*100//total_services}%)")
        report.append(f"- **Services using config files:** {services_using_config} ({services_using_config*100//total_services}%)")
        report.append(f"- **Services with hardcoded values:** {services_with_hardcoded} ({services_with_hardcoded*100//total_services}%)")
        report.append("")
