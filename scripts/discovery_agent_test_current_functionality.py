...
class DiscoveryAgentTester:
    ...
    def test_original_discovery(self):
        ...
        try:
            ...
            response = requests.post(f"{self.base_url}/discover", json=payload, timeout=30)
    ...
    def test_enhanced_endpoints_availability(self):
        ...
        enhanced_endpoints = ["/discover-ecosystem", "/registry/stats", "/monitoring/dashboard"]
    ...
    def test_network_url_normalization(self):
        ...
        test_cases = [
            ...
            {"input_url": "http://127.0.0.1:5050", "service_name": "doc_store", "expected": "http://doc_store:5050"},
            {
