                ...
                async with semaphore:
                    ...
                    try:
                        ...
                        progress.update(audit_task, advance=1,
                                      description=f"✅ {service_name} ({duration:.1fs}) | {completed_count}/{len(services)} done{eta_str}")

                        logger.info("✅ Completed audit for %s in %.1fs (Score: %.1f, Grade: %s)",
                        ...
                        logger.error("❌ Audit failed for %s after %.1fs: %s", service_name, duration, e)
                        ...
                        progress.update(audit_task, advance=1, description=f"❌ Failed {service_name} ({duration:.1fs})")
                        return error_result
