...
def test_review_feedback_generation():
    ...
    try:
        ...
        criteria_analyses = {
            ...
            "accuracy": {"score": 0.9, "issues": [], "suggestions": ["Consider adding version information"]},
        }

        overall_assessment = {"overall_score": 0.82, "grade": "B", "description": "Good documentation quality"}
    ...
    try:
        ...
        **Request Body:**
        ...
        result = await enhancer.review_documentation(
            content=test_content, doc_type="api_reference", title="API Developer Guide v1.0"
        )
    ...
    try:
        ...
        **Request Body:**
        ...
        result = await enhancer.compare_document_versions(
            old_content=old_content, new_content=new_content, doc_type="api_reference"
        )
