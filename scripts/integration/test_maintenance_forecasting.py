...
def test_maintenance_urgency_calculation():
    ...
    try:
        ...
        high_risk_urgency = forecaster._calculate_maintenance_urgency(
            "risk_score", 0.8, forecaster.maintenance_factors["risk_score"]
        )
        ...
        low_risk_urgency = forecaster._calculate_maintenance_urgency(
            "risk_score", 0.2, forecaster.maintenance_factors["risk_score"]
        )
        ...
        old_doc_urgency = forecaster._calculate_maintenance_urgency(
            "document_age", 300, forecaster.maintenance_factors["document_age"]
        )
        ...
        high_usage_urgency = forecaster._calculate_maintenance_urgency(
            "usage_frequency", 500, forecaster.maintenance_factors["usage_frequency"]
        )
...
def test_maintenance_recommendations():
    ...
    try:
        ...
        medium_forecast = {"overall_forecast": {"priority_level": "medium", "predicted_days": 75}, "urgent_factors": []}
