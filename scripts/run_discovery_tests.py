...
def run_integration_tests():
    ...
    try:
        ...
        # Log to monitoring
        monitoring.log_discovery_event("discovery_complete", {"services": 2, "tools": 4, "status": "success"})
...
def run_functional_tests():
    ...
    try:
        ...
        monitoring.log_discovery_event(
            "ecosystem_discovery",
            {"services_tested": 3, "tools_discovered": 6, "performance_summary": "completed successfully"},
        )
