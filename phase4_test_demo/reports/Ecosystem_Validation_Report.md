...
Timestamp: 2025-10-04T05:50:56.832736
...
Timestamp: 2025-10-04T05:50:56.833041
Proof Type: LIVE_MODULE_IMPORT
```
...
Line: 119
Timestamp: 2025-10-04T05:50:57.366474
...
- `main()` at `/Users/mykalthomas/Documents/work/Hackathon/demo_hyper_realistic_parameterized.py:4446`
- `run_demo()` at `/Users/mykalthomas/Documents/work/Hackathon/demo_hyper_realistic_parameterized.py:4237`
- `execute_workflow_e()` at `/Users/mykalthomas/Documents/work/Hackathon/demo_hyper_realistic_parameterized.py:1336`
...
Line: 1357
Timestamp: 2025-10-04T05:50:57.366489

Arguments:
{
  "feature_query": "Build authentication and authorization system with",
  "tech_stack": [
    "Python",
    "FastAPI",
    "PostgreSQL",
...
python demo_hyper_realistic_parameterized.py \
  --feature "Build authentication and authorization system with OAuth 2.0..." \
  --tickets 15 \
  --team 6 \
  --tech Python FastAPI PostgreSQL \
  --output phase4_test_demo
```
...
**Validation Results**:
- ✅ Documents processed: 6 GitHub PRs, 4 Jira tickets, 4 Confluence docs
- ✅ Users extracted: 10 unique users (if Workflow F executed)
- ✅ SMEs identified: 12 experts (if Workflow F executed)
